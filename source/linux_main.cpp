...
int main(int argc, char **argv)
{
    ...
    std::vector<char> result_file_name;
    {
        ...
        QFontDatabase::addApplicationFontFromData(QByteArray::fromRawData(reinterpret_cast<char *>(noto_sans_ttf_data_base), noto_sans_ttf_data_size));
        QFontDatabase::addApplicationFontFromData(QByteArray::fromRawData(reinterpret_cast<char *>(noto_sans_cjk_jp_ttf_data_base), noto_sans_cjk_jp_ttf_data_size));
        QFontDatabase::addApplicationFontFromData(QByteArray::fromRawData(reinterpret_cast<char *>(noto_sans_symbols_ttf_data_base), noto_sans_symbols_ttf_data_size));
        QFontDatabase::addApplicationFontFromData(QByteArray::fromRawData(reinterpret_cast<char *>(noto_sans_symbols2_ttf_data_base), noto_sans_symbols2_ttf_data_size));
