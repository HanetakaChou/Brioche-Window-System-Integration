        ...
        run_loop_observer = CFRunLoopObserverCreate(
            ...
            [](CFRunLoopObserverRef observer, CFRunLoopActivity activity, void *wrapped_info) -> void
            {
                ...
                if (s_running)
                {
                    ...
                    assert(view_bounds.size.width == s_main_window_width);
                    assert(view_bounds.size.height == s_main_window_height);
                    ...
                    if ((std::abs(view_scale.width - s_main_window_width_scale) > 1E-3F) || (std::abs(view_scale.height - s_main_window_height_scale) > 1E-3F))
                    {
                        s_main_window_width_scale = view_scale.width;
                        s_main_window_height_scale = view_scale.height;
